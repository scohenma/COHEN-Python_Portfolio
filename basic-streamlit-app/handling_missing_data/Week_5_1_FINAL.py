...
st.write(df.shape) # to find number of columns and rows
...
st.dataframe(df.isnull().sum()) #using .sum to find a series of numbers based on features, instead of a true and false. This gives us the number of null values in all variables


# ------------------------------------------------------------------------------
# Visualize Missing Data with a Heatmap
# ------------------------------------------------------------------------------
# Create a heatmap to visually indicate where missing values are
...
# ------------------------------------------------------------------------------
# Create a copy to preserve the original data. df_clean is going to be a copy that
#  will change with the custom filters. 
df_clean = df.copy() #this to copy a dataframe. 
